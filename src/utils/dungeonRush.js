...
const special = [
  ...
  'use only four (4) instruments',
  'the album must have four (4) songs',
  ...
  'at least two (2) songs must be in an odd meter (5/4, 7/8, etc)',
  'use a reversed audio effect in each song',
  'incorporate silence into at least two (2) songs',
  'use only four (4) notes in at least one (1) song (ex: C, D, G, A; can use these notes in any octave)',
  'create a musical ‘theme’ or ‘motif’ that is used in at least half the songs (ex: a short melody or series of notes)',
  'base at least two (2) songs on a loop that plays throughout those songs',
  ...
  'at least one (1) song must be under one (1) minute long',
  'at least one (1) song must be over five (5) minutes long',
