  ...
  render(){
    return(
      <>
        ...
        <p>I'm still an active musician making my own strange music that ranges from extreme metal to meditative ambience. Gardening is my favorite destressing activity. Many of the plants I grow are used in herbal remedies I make. I try to hold a few classes a year to assist people with gaining basic practical herbal knowledge.</p>
