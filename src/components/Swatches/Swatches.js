...
export default function Swatches() {
  ...
  return (
    <>
    <Header />
    <div className="swatch-wrapper" style={isBgWhite ? {backgroundColor:"#fff"} : {backgroundColor:"#000"}}>
      <button
        className="swatch-toggle-btn"
        style={{top:`${btnPos}px`}}
        onClick={() => setIsBgWhite(!isBgWhite)}
      >
        <span className={isBgWhite ? "swatch-toggle-icon--inactive" : "swatch-toggle-icon--active"}></span>
      </button>
